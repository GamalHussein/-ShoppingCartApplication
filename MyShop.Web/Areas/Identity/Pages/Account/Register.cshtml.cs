    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if(!_roleManager.RoleExistsAsync(userRole.AdminRole).GetAwaiter().GetResult())
            {
				...
				_roleManager.CreateAsync(new IdentityRole(userRole.EditorRole)).GetAwaiter().GetResult();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
				...
				if (result.Succeeded)
                {
					...
					{
						_userManager.AddToRoleAsync(user, userRole.CustomerRole).GetAwaiter().GetResult();
